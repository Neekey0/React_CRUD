...
const empReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case actionTypes.SET_EMPLOYEE_QUALIFICATION:
            ...
            // console.log(newQualObj, "state.empQualification");
            return {
                ...state,
        ...
        case actionTypes.DELETE_EMPLOYEE_DETAILS:
            let ind = state.empQuaList.findIndex(
        ...
        case actionTypes.DELETE_EMPLOYEE_DOCUMENT:
            let d_ind = state.empDocs.findIndex((x) => x.documentId == action.data);
        ...
        case actionTypes.EDIT_QUALIFICATION:
            // console.log(action.data, "action data from edit");
        ...
        case actionTypes.EDIT_DOCUMENT:
            ...
            console.log(edit_Data, "Edit dataaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
            return {
                ...state,
        ...
        case actionTypes.SET_EMPLOYEE_DETAIL:
            // console.log(action.data,"action.data from get all emp details API--------------")
            return {
                ...state,
                employee: action.data,
            };
        ...
        case actionTypes.FILE_SPLIT:
            // console.log(action.data, "file data");
            let empfile = Object.assign({}, state.File, action.data);
            // state.empDocument.File = file;
            // console.log(file, "data after assign ");
            return {
                ...state,
                empDocument: {
                    ...state.empDocument,
        ...
        case actionTypes.SET_DOCUMENT_EDIT:
            // const { keyValue, id } = action.data;
            // console.log(action.data, "keyvalues+++++++++++++++++");
            obj = {};
