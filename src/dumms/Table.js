...
const table = ({ tableField1, tableField2 }) => {
    ...
    // console.log(qualList, "qualification---------");
    // console.log(empDocument, "empDocument---------");
            ...
            <>
                <tr>
                    ...
                    <td>
                        ...
                        <button
                            className="add-btn btn"
                            onClick={(e) => onDelete(props.item.qualificationId, e)}
                        >
                            Delete
                        </button>
                    </td>
    ...
    function EditDoc(props) {
        // console.log(props, "props from doc edit+++++++++++++++++++++++");
        return (
            <>
                <tr>
                    <td className="table-data">
                    ...
                    <td>
                        ...
                        <button
                            className="add-btn btn"
                            onClick={(e) => onDeleteDocs(props.item.documentId, e)}
                        >
                            Delete
                        </button>
                    </td>
                                ...
                                return updateState === item.qualificationId ? (
                                    ...
                                    <tr key={item.qualificationId}>
                                        ...
                                        <td>
                                            ...
                                            <button
                                                className="add-btn btn"
                                                onClick={(e) => onDelete(item.qualificationId, e)}
                                            >
                                                Delete
                                            </button>
                                        </td>
                            ...
                            : empDocs.map((item, index) => {
                                ...
                                return updateDocState === item.documentId ? (
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className="table-data">{item.File.fileName}</td>
                                        <td>
                                            <button
                                                className="add-btn btn"
                                                onClick={(e) => {
                                            ...
                                            <button
                                                className="add-btn btn"
                                                onClick={(e) => onDeleteDocs(item.documentId, e)}
                                            >
                                                Delete
                                            </button>
                                        </td>
